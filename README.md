...
## Changes in the Code
You have to set the WLAN access details in the [code](https://github.com/AK-Homberger/Alexa-Face-Recognition-with-ESP32CAM/blob/7309739b7eb9232a8c7e793171e5be40f4c19052/AlexaFaceDetectionESP32Cam/AlexaFaceDetectionESP32Cam.ino#L45):
```
const char *ssid = "ssid";
const char *password = "password";
```

And you have to set the different URLs in the array [URL](https://github.com/AK-Homberger/Alexa-Face-Recognition-with-ESP32CAM/blob/7309739b7eb9232a8c7e793171e5be40f4c19052/AlexaFaceDetectionESP32Cam/AlexaFaceDetectionESP32Cam.ino#L49):
```
...
## Root CA Certificate
For security reasons the [Root CA certificate](https://github.com/AK-Homberger/Alexa-Face-Recognition-with-ESP32CAM/blob/7309739b7eb9232a8c7e793171e5be40f4c19052/AlexaFaceDetectionESP32Cam/AlexaFaceDetectionESP32Cam.ino#L59) is stored in the code. 
